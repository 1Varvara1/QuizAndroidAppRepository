package com.example.quizapplication.constrants;
...
public class AppConstants {
    ...
    public static final String Test_FILE = "json/test.json";

    public static final String  JSON_Question_set_fileName= "q_set.json";
    public static final String  JSON_Quiz_category_fileName= "q_category.json";
